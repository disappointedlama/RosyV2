...
class Position {
	...
	inline void legal_bpawn_pushes(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, int& ind);
	inline void legal_wpawn_pushes(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, int& ind);
	inline void legal_bpawn_captures(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, int& ind);
	inline void legal_wpawn_captures(std::array<unsigned int, 128>& ret, const U64 enemy_attacks, const U64 pinned, int& ind);

	inline void in_check_get_legal_pawn_moves(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, const U64 targets, const U64 in_check_valid, int& ind);
	inline void in_check_legal_bpawn_pushes(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, const U64 targets, const U64 in_check_valid, int& ind);
	inline void in_check_legal_wpawn_pushes(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, const U64 targets, const U64 in_check_valid, int& ind);
	inline void in_check_legal_bpawn_captures(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, const U64 targets, int& ind);
	inline void in_check_legal_wpawn_captures(std::array<unsigned int,128>& ret, const U64 enemy_attacks, const U64 pinned, const U64 targets, int& ind);
